...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h4>Selamat Datang <?php echo $nama; ?> di WebGIS <small>PETANENYONG</small></h4>
    <p>Designed and Developed By Ammar Annajih Pasifiky (Frontend and Backend), A.Hadif.G (Frontend), Liza Rifan Muazin (android) and Rasyid Salman(Map Drawer)</p>
    <p>Maps Code Reference from Juon Junior, Wasis Ramadhan, and Onyip Gedhang </p>
