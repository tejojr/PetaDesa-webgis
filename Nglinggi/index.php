...
?>
 ...
 <script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?key=AIzaSyDXiSYMiXoXZ177aomSAyClROEJ-o8Siow&sensor=false&language=id"></script>
...
if ("geolocation" in navigator){
            navigator.geolocation.getCurrentPosition(show_location, show_error, {timeout:1000, enableHighAccuracy: true, maximumAge:0});
             map.setCenter(pos);
        }else{
		...
		map.controls[google.maps.ControlPosition.LEFT_BOTTOM].push(legenda);
		map.controls[google.maps.ControlPosition.LEFT_BOTTOM].push(petadesa);
		map.controls[google.maps.ControlPosition.LEFT_BOTTOM].push(lokasiku);
	}
