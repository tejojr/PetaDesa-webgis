...
if (isset($_POST['submit'])) {
	...
	if ($row > 0) {
		...
		echo "<meta http-equiv='refresh' content='0; url=views/admin/'>";
	} else {
    ...
    <div class="row">
     ...
     <div class="col-lg-4">
       ...
       <div class="jumbotron" style="margin-top: 150px">
        <h4 class="text-center">Login WebGIS<small>SRINTEKDES</small></h4><br>
        <form action="#" method="POST">
          ...
          <br>
          <br>
          <p class="text-center"><small>TIM IT BLC TELKOM KLATEN</small></p>
        </form>
      </div>
    </div>
  </div>
